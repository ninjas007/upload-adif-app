...
class Adif {
    ...
    public $data; //the adif data
    public $i; //the iterator
    public $current_line; //stores information about the current qso
    ...
    public function initialize() //this function locates the <EOH>
    {
        ...
        {
            return response([
                'msg' => 'Error: Adif_Parser Already Initialized or No <EOH> in ADIF File. Please send your file adif to email: hq.yb6dxc@gmail.com',
        ...
        {
            return response([
                'msg' => 'Error: ADIF File Does Not Contain Any QSOs. Please send your file adif to email: hq.yb6dxc@gmail.com',
                'status' => http_response_code(400)
            ], 400);
        };
        return 1;
    ...
    public function record_to_array($record)
    {
        ...
        {           
            if($record[$a] == '<') //find the start of the tag
            {
                ...
                {
                    $tag_name = $tag_name.$record[$a]; //append this char to the tag name // result call, gridsquar, dll
                    $a++;
                };
